...
namespace ProEventos.Persistence.Migrations
{
    ...
    [Migration("20220824021842_Adicionando-Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProEventos.Domain.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ProEventos.Domain.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("ProEventos.Domain.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("ProEventos.Domain.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProEventos.Domain.UserRole", b =>
                {
                    b.HasOne("ProEventos.Domain.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
